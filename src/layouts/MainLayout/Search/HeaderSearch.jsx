...
const HeaderSearch = ({ square = false,placeholder,width='250px'}) => {
  return (
    <div className="">
  ...
  style={{
    ...
    className={`pl-10 pr-4 py-2 border border-[#dfe5ef] focus:outline-none ${square ? 'rounded-[5px]' : 'rounded-3xl'}`}
  />
</div>
    </div>
